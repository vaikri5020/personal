...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-only-oceandepth-ai-change-before-production",
)
...
# Email verification. Use a Gmail App Password, never your normal Gmail password.
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "noreply@oceandepth.local")
